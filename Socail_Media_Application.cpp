...
map<string, User> mapUserName;                 // Map username to User
map<string, set<string>> friendsMap;           // Map friends
map<string, SocialGroup> mapGroups;            // Map group name to SocialGroup
map<pair<string, string>, vector<Message>> userMessages; // Map for storing messages between users
